...
/// <summary>Detects players in a frame, independent of sport classification or calibration - runs on every captured frame (not cached per-source, per vision/player-detection spec).</summary>
