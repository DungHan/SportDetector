...
public partial class MinimapViewModel : ViewModelBase
{
    ...
    public void SetMarkers(IEnumerable<CourtMarker> markers)
    {
        ...
        {
            Markers.Add(marker);
            MarkerVisuals.Add(new AnnotationVisual(marker.X * PixelsPerMeter, marker.Y * PixelsPerMeter, null, null, marker.Label, marker.StyleKey, marker.Color, marker.Opacity));
        }
    }
