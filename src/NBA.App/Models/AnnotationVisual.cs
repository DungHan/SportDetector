...
/// </summary>
public sealed record AnnotationVisual(double X, double Y, double? Width, double? Height, string? Label)
{
    public static AnnotationVisual? FromAnnotation(OverlayAnnotation annotation) => annotation.Shape switch
    {
        OverlayShapeKind.Point when annotation.Points.Count >= 1 =>
            new AnnotationVisual(annotation.Points[0].X, annotation.Points[0].Y, null, null, annotation.Label),
